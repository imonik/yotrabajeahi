...
{
	internal partial class YotaDB : IQuerySurface
	{
		...
		public YotaDB() 
		{ 
			DataProvider = ProviderFactory.GetProvider("Yota");
			Init();
		}

		public YotaDB(string connectionStringName)
		{
			DataProvider = ProviderFactory.GetProvider(connectionStringName);
			Init();
		}

		public YotaDB(string connectionString, string providerName)
		{
